<x-app-layout>
    <div class="container mx-auto py-8">
        ...
        <a href="{{ route('presences.create') }}"
            class="mb-4 inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Ajouter une présence</a>
            ...
            <tbody>
                @foreach ($presences as $presence)
                    <tr>
                        ...
                        <td class="py-2 px-4 border"> {{ $presence->seance->module->nom ?? '-' }} {{ $presence->seance->date ?? '' }}</td>
