    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-8">
            <div class="container mx-auto py-4">
                ...
                @endif
                <a href="{{ route('annee_academiques.create') }}"
                    class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Ajouter une année académique</a>
                        ...
                        @foreach ($anneesAcademiques as $aa)
                            <tr>
                                ...
                                <td class="py-2 px-4 border flex gap-2">
                                    ...
                                    <form action="{{ route('annee_academiques.destroy', $aa) }}" method="POST"
                                        onsubmit="return false;" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="openModal({{ $aa->id }})"
