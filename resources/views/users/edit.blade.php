    ...
    <div class="max-w-xl mx-auto mt-10 bg-white p-8 rounded shadow">
        ...
        <form method="PUT" action="{{ route('users.update',$user->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="identifiant" id="identifiant" value="{{ old('identifiant',$user->identifiant) }}" required
                    class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" value="{{ old('password',$user->password) }}" required class="w-full border rounded px-3 py-2">
            </div>
