{{-- Vue : Formulaire pour ajouter une séance (date, salle, type, classe, module, prof) --}}
<x-app-layout>
        ...
        <form action="{{ route('seances.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="date" id="date"
                    class="w-full border rounded px-3 py-2 mt-1"required value="{{ old('date') }}">
                @error('date')
