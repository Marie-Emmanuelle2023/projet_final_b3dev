<x-app-layout>
    <div class="container mx-auto py-8">
        ...
        <a href="{{ route('parent_models.create') }}" class="mb-4 inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Ajouter un parent</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border flex gap-2">
                        <a href="{{ route('parent_models.show', $parent) }}" class="px-2 py-1 bg-green-500 text-white rounded">Voir</a>
                        <a href="{{ route('parent_models.edit', $parent) }}" class="px-2 py-1 bg-yellow-500 text-white rounded">Modifier</a>
                        ...
                        <div id="modal-{{ $parent->id }}" tabindex="-1" class="hidden fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto h-[calc(100%)] bg-black bg-opacity-50 items-center justify-center">
                            <div class="bg-white rounded-lg shadow p-6 w-full max-w-md">
                                ...
                                <form method="POST" action="{{ route('parent_models.destroy', $parent) }}">
                                    @csrf
                                    @method('DELETE')
