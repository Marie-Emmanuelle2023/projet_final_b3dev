<x-app-layout>
    <div class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded shadow">
        ...
        <a href="{{ route('modules.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">Ajouter
            un module</a>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            ...
                            <button data-modal-target="module-modal-{{ $module->id }}"
                                data-modal-toggle="module-modal-{{ $module->id }}" class="btn btn-danger btn-sm"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500">Voulez-vous vraiment
                                                supprimer le module <span class="font-bold">{{ $module->nom }}</span>
                                                ?</h3>
                                            ...
                                            <button data-modal-hide="module-modal-{{ $module->id }}" type="button"
