    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-8">
            <div class="container mx-auto py-8">
                <h1 class="text-2xl font-bold mb-6">Présence pour {{ $seance->module->nom }} - {{ $seance->classe->nom }}
                </h1>
                ...
                <form method="POST" action="{{ route('professeurs.enregistrer', $seance) }}">
                    ...
                    <button type="submit"
                        class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">Enregistrer</button>
                </form>
            </div>
        </main>
    </div>
